export const Github = () => {
  return (
    <div className="w-full h-[130px] col-span-2 rounded-md bg-cardLight border-borderLight border-2 border-solid dark:bg-cardDark dark:border-borderDark shadow-sm shadow-gray-900/5">
