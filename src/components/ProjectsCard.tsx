...
export const ProjectsCard = () => {
  ...
  return (
    <div className="relative w-full h-[130px] rounded-md border-blue-600/10 border-4 border-solid shadow-sm shadow-gray-900/5 sm:grid-projects sm:row-start-6 sm:row-end-8 lg:h-full lg:col-start-3 lg:col-end-4 lg:row-start-2 lg:row-end-4 xl:col-start-3 xl:col-end-4 xl:row-start-2 xl:row-end-3 overflow-hidden card-animation scroll-reveal dark:bg-[linear-gradient(to_right,_rgba(79,70,229,0.1)_0%,_rgba(8,145,178,0.1)_100%)] hover:border-blue-600/40 cursor-pointer">
