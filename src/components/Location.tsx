...
export const Location = () => {
  return (
    <div className="w-full h-[200px] col-span-2 rounded-md bg-cardLight border-borderLight border-4 border-solid dark:bg-cardDark dark:border-borderDark shadow-sm shadow-gray-900/5">
