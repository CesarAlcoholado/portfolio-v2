...
export const Mode = () => {
  ...
  return (
    <div
      className="w-full h-[130px] rounded-md bg-backgroundLight border-borderLight border-4 border-solid dark:bg-backgroundDark dark:border-borderDark shadow-sm shadow-gray-900/5 md:grid-mode md:h-full md:row-start-1 md:row-end-2 lg:col-start-2 lg:col-end-3 lg:row-start-2 lg:row-end-3 xl:col-start-2 xl:col-end-3 xl:row-start-1 xl:row-end-2 card-animation scroll-reveal cursor-pointer"
      onClick={toggleMode}
    >
