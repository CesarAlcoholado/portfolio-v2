...
export const Email = () => {
  ...
  return (
    <div className="w-full h-[80px] col-span-2 rounded-md bg-backgroundLight border-borderLight border-4 border-solid dark:bg-backgroundDark dark:border-borderDark shadow-sm shadow-gray-900/5 md:grid-email md:h-full md:row-start-3 md:row-end-4 md:col-start-2 md:col-end-3 xl:col-start-3 xl:col-end-4 xl:row-start-3 xl:row-end-4 card-animation scroll-reveal cursor-pointer">
