...
export const NavBar = () => {
  ...
  return (
    <nav className="w-auto h-11 font-montserrat rounded-md bg-cardLight border-borderLight border-4 border-solid dark:bg-backgroundDark dark:border-borderDark shadow-sm shadow-gray-900/5 m-1.5 md:h-14 card-animation">
