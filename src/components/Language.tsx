...
export const Language = () => {
  ...
  return (
    <div className="w-full h-[130px] rounded-md bg-cardLight border-borderLight border-4 border-solid dark:bg-backgroundDark dark:border-borderDark shadow-sm shadow-gray-900/5 sm:grid-language sm:h-full sm:row-start-2 sm:row-end-3 lg:col-start-2 lg:col-end-3 lg:row-start-3 lg:row-end-4 xl:col-start-2 xl:col-end-3 xl:row-start-2 xl:row-end-3">
